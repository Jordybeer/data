...
export const DrugItem: React.FC<DrugItemProps> = ({ drug, onClick }) => (
  <button
    onClick={onClick}
    className={
      'card p-4 text-left w-full transition-all duration-200 group ' +
      'hover:border-blue-400/25 hover:bg-[rgba(20,40,80,0.55)] ' +
      'active:scale-[0.98] active:brightness-95'
    }
  >
    <h3 className="font-semibold text-base text-textc group-hover:text-primary transition-colors mb-2 leading-snug">
      {drug.name}
    </h3>
